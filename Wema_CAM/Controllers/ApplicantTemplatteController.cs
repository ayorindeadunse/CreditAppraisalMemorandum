...
{
    public class ApplicantTemplatteController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ////                    && ca.CAMId == bc.CAMId
            ////                      && ca.InitiatedBy == user
            ////                      && ca.Status != "Approved" && ca.Status != "Declined"
        ...
        [HttpPost]
        public ActionResult Index(string sstartdate, string eenddate)
        {
        ...
        //
        // POST: /ApplicantTemplatte/Create

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(string sstartdate, string eenddate)
        {
            if (sstartdate == "" && eenddate == "")
            {

                ViewBag.SpecifyDate = "Please specify the date to retrieve CAM templates.";
            }

            else
            {
                DateTime starrtdate = DateTime.Parse(sstartdate.ToString());
                DateTime ennddate = DateTime.Parse(eenddate.ToString());
                //if (ModelState.IsValid)
                //{
                ...
                try
                {
                    ...
                    var pendingCAMs1 = from ca in db.CAM
                                       // join ab in db.CreditRequestSummary on ca.CAMId equals ab.CAMId
                                       join bc in db.CreditRequestSummary on ca.CAMId equals bc.CAMId
                                       join ba in db.ApplicantsBrief on ca.ApplicantID equals ba.ApplicantID
                                       join ft in db.FacilityType on bc.Facility equals ft.id
                                       ...
                                       where ca.CAMId == bc.CAMId
                                         && ca.InitiatedBy == user
                                         && ca.CreationDate >= starrtdate && ca.CreationDate <= ennddate
                    ...
                    // var distinctcams = pendingCAMs.Distinct();
                    var distinctcams1 = pendingCAMs1.OrderByDescending(s => s.DateLastUpdated);
                    ...
                    //ViewBag.TemplateCAM = pendingcams1.ToPagedList(pageNumber, pageSize);
                    ViewBag.TemplateCAM = pendingcams1;
        ...
        //
        // POST: /ApplicantTemplatte/Edit/5
        ...
        //
        // GET: /ApplicantTemplatte/Delete/5
        ...
        //
        // POST: /ApplicantTemplatte/Delete/5
