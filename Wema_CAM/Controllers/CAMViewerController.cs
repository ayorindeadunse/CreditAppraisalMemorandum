...
{
    public class CAMViewerController : Controller
    {
      // List<CAM> outstandingCAMsList;
        ...
        public ActionResult Index( int? page)
        {
                ...
                try
                {
                    ...
                    var pendingCAMs = from ca in db.CAM
                                      ...
                                      where ca.CAMId == bc.CAMId
                                       ...
                                       && ca.InitiatedBy != ca.DestinationUserId
                                        && ca.Status == "Pending"
            ...
            {
                //var outstandingCAMs = from c in db.CAM where c.DestinationUserId == outstandingCAMsList && c.Status=="Pending"  select c;
                //if (outstandingCAMs != null)
            ...
            try
            {
                ...
                if (Session["UserFunction"] != null)
                {
                    ...
                    if (designationofuser == "BDM")
                    {
                        ...
                        var transactions = from ca in db.CAM
                                          ...
                                          where ca.BranchProcessedFrom == branchofuser
                                          && ca.Status == status1
                                          ...
                                          select new
                                          {
                                              ...
                                              ft.description,
                                              ca.TotalFacilityAmount,
                                              ca.BranchProcessedFrom,
                                              ca.ZoneProcessedFrom,
                                              ca.RegionProcessedFrom,
                                              ca.Status,
                                              ca.InitiatedBy,
                                              ca.DestinationUserId,
                                              ca.CreationDate,  
                        ...
                        List<ListOfTransactions> listoftransactions = new List<ListOfTransactions>();

                        foreach (var t in transactions)
                        {
                           listoftransactions.Add(new ListOfTransactions
                            {
                                camid = long.Parse(t.CAMId.ToString()),
                                customername = t.LegalIdentityName,
                                facilitytype = t.description,
                                facilityamount = t.TotalFacilityAmount,
                                branchprocessed = t.BranchProcessedFrom,
                                zoneprocessed = t.ZoneProcessedFrom,
                                regionprocessed = t.RegionProcessedFrom,
                                status = t.Status,
                                initiatedby = t.InitiatedBy,
                                currentlocation = t.DestinationUserId,
                           
                                datelastupdatedoutput = string.Format("{0:D2} hrs,{1:D2} mins,{2:D2} secs", DateTime.Now.Subtract(DateTime.Parse(t.DateLastUpdated.ToString())).Hours.ToString(), DateTime.Parse(t.DateLastUpdated.ToString()).Minute, DateTime.Parse(t.DateLastUpdated.ToString()).Second)
                            });
                        }
                        string tableStructure = "<table class=\"tblboda1\"><tr><th>Cam Id</th><th>Customer Name</th><th>Facility Type</th><th>Facility Amount</th><th>Branch Processed</th><th>Zone Processed</th><th>Region Processed</th><th>Status</th><th>Initiated By</th><th>Current Location</th><th>Time Elapsed</th></tr>";
                            foreach (var f in listoftransactions)
                            {
                                tableStructure = tableStructure + "<tr><td>" + f.camid + "</td>" + "<td>" + f.customername + "</td>" + "<td>" + f.facilitytype + "</td>" + "<td>" + f.facilityamount + "</td>" + "<td>" + f.branchprocessed + "</td>" + "<td>" + f.zoneprocessed + "</td>" + "<td>" + f.regionprocessed + "</td>" + "<td>" + f.status + "</td>" + "<td>" + f.initiatedby + "</td>" + "<td>" + f.currentlocation + "</td>" + "<td>" + f.datelastupdatedoutput + "</td>" + "</tr>";
                            }
                  ...
                  var transactions = from ca in db.CAM
                                           ...
                                           where ca.ZoneProcessedFrom == zoneofuser
                                           && ca.Status == status1
                        ...
                        else if (designationofuser == "RE")
                        {
                            ...
                            var transactions = from ca in db.CAM
                                               ...
                                               where ca.RegionProcessedFrom == regionofuser
                                               && ca.Status == status1
                        ...
                        {
                            branchofuser = Session["BRANCH"].ToString();
                            //var camstreatedinregion = from cr in db.CAM 
                            //                          join ab in db.ApplicantsBrief on cr.ApplicantID equals ab.ApplicantID
                            //                          join ac in db.ApplicantType on ab.ApplicantType equals ac.id
                            //                          where cr.ApplicantID == ab.ApplicantID
                            //                          &&  cr.BranchProcessedFrom == branchofuser && cr.Status == status1 
                            //                          && ac.descritpion == "Corporate"

                            //                          select new  {
                            //                              cr.CAMId,cr.BranchProcessedFrom,cr.ZoneProcessedFrom,cr.RegionProcessedFrom,
                            //                              ac.descritpion, cr.Status,cr.InitiatedBy,cr.DestinationUserId,cr.CreationDate
                                                      
                            //                       };

                            //List<corporatecredits> corpcredit = new List<corporatecredits>();
                            //foreach (var s in camstreatedinregion)
                            //{
                            //    corpcredit.Add(new corporatecredits
                            //    {
                            //        camid = s.CAMId,
                            //        branchprocessedfrom = s.BranchProcessedFrom,
                            //        zoneprocessed = s.ZoneProcessedFrom,
                            //        regionprocessed = s.RegionProcessedFrom,
                            //        credittype = s.descritpion,
                            //        status = s.Status,
                            //        initiatedby = s.InitiatedBy,
                            //        currentlocation = s.DestinationUserId,
                            //        datecreated = DateTime.Parse(s.CreationDate.ToString()),
                            ...
                            //    string tableStructure = "<table class=\"tblboda1\"><tr><th>Cam Id</th><th>Branch Processed</th><th>Zone Processed</th><th>Region Processed</th><th>Credit Type</th><th>Status</th><th>Initiated By</th><th>Current Location</th><th>Date Created</th></tr>";
                            //    foreach (var f in corpcredit)
                            //    {

                            //        tableStructure = tableStructure + "<tr><td>" + f.camid + "</td>" + "<td>" + f.branchprocessedfrom + "</td>" + "<td>" + f.zoneprocessed + "</td>" + "<td>" + f.regionprocessed + "</td>" + "<td>" + f.credittype+"</td>" + "<td>" + f.status + "</td>" + "<td>" + f.initiatedby + "</td>" + "<td>" + f.currentlocation + "</td>" + "<td>" + f.datecreated + "</td>" + "</tr>";
                            //    }
                            ...
                            var transactions = from ca in db.CAM
                                               ...
                                               join bc in db.CreditRequestSummary on ca.CAMId equals bc.CAMId
                                               join ba in db.ApplicantsBrief on ca.ApplicantID equals ba.ApplicantID
                                               join ac in db.ApplicantType on ba.ApplicantType equals ac.id
                                               join ft in db.FacilityType on bc.Facility equals ft.id


                                               where ca.BranchProcessedFrom == branchofuser
                                               && bc.ApplicantID == ba.ApplicantID
                                               && ca.Status == status1
                                               && ac.descritpion == "Corporate"
                            ...
                            List<corporatecredits> listoftransactions = new List<corporatecredits>();

                            foreach (var t in transactions)
                            {
                                listoftransactions.Add(new corporatecredits
                                {
                                    camid = long.Parse(t.CAMId.ToString()),
                                    customername = t.LegalIdentityName,
                                    facilitytype = t.description,
                                    facilityamount = t.TotalFacilityAmount,
                                    branchprocessedfrom = t.BranchProcessedFrom,
                                    zoneprocessed = t.ZoneProcessedFrom,
                                    regionprocessed = t.RegionProcessedFrom,
                                    credittype = t.descritpion,
                                    status = t.Status,
                                    initiatedby = t.InitiatedBy,
                                    currentlocation = t.DestinationUserId,
                            ...
                            string tableStructure = "<table class=\"tblboda1\"><tr><th>Cam Id</th><th>Customer Name</th><th>Facility Type</th><th>Facility Amount</th><th>Branch Processed</th><th>Zone Processed</th><th>Region Processed</th><th>Credit Type</th><th>Status</th><th>Initiated By</th><th>Current Location</th><th>Time Elapsed</th></tr>";
                            foreach (var f in listoftransactions)
                            {
                                tableStructure = tableStructure + "<tr><td>" + f.camid + "</td>" + "<td>" + f.customername + "</td>" + "<td>" + f.facilitytype + "</td>" + "<td>" + f.facilityamount + "</td>" + "<td>" + f.branchprocessedfrom + "</td>" + "<td>" + f.zoneprocessed + "</td>" + "<td>" + f.regionprocessed + "</td>" + "<td>" + f.credittype + "</td>" + "<td>" + f.status + "</td>" + "<td>" + f.initiatedby + "</td>" + "<td>" + f.currentlocation + "</td>" + "<td>" + f.datelastupdatedoutput + "</td>" + "</tr>";
                            }
                    ...
                    else if (designationofuser == "GH")
                    {
                        ...
                        //                          {
                        //                              cr.CAMId,
                        //                              cr.BranchProcessedFrom,
                        //                              cr.ZoneProcessedFrom,
                        //                              cr.RegionProcessedFrom,
                        //                              ac.descritpion,
                        //                              cr.Status,
                        //                              cr.InitiatedBy,
                        //                              cr.DestinationUserId,
                        //                              cr.CreationDate
                        ...
                        var transactions = from ca in db.CAM
                                        ...
                                        //   where ca.BranchProcessedFrom == branchofuser
                                               where bc.ApplicantID == ba.ApplicantID
                                           && ca.Status == status1
                                           && ac.descritpion == "Corporate"
                ...
                if (Session["UserFunction"] != null)
                {
                    ...
                    if (designationofuser == "BDM")
                    {
                        ...
                        var transactions = from ca in db.CAM
                                           ...
                                           where ca.BranchProcessedFrom == branchofuser
                                           && ca.Status == status1
                                           && ca.CreationDate >= startdate3 && ca.CreationDate <= enddate3
